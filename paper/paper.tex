...
In this paper, we detail the design decisions, architecture, and implementation of a web-based tourism recommender system prototype that is compliant with the DSA. It addresses both transparency and user-influence goals by implementing two algorithms:
\begin{enumerate}
